...
func index(c *gin.Context) {
	c.HTML(http.StatusOK, "web/templates/index.gohtml", nil)
}

func hello(c *gin.Context) {
	c.HTML(http.StatusOK, "web/templates/hello/hello.html", nil)
}

func world(c *gin.Context) {
	c.HTML(http.StatusOK, "web/templates/hello/world/world.html", nil)
}
